...
{
    default void addWorker(WorkerPrx w)
    {
        addWorker(w, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void addWorker(WorkerPrx w, java.util.Map<String, String> context)
    {
        _iceI_addWorkerAsync(w, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> addWorkerAsync(WorkerPrx w)
    {
        return _iceI_addWorkerAsync(w, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> addWorkerAsync(WorkerPrx w, java.util.Map<String, String> context)
    {
        return _iceI_addWorkerAsync(w, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_addWorkerAsync(WorkerPrx iceP_w, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default void addClient(ClientPrx c)
    {
        addClient(c, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void addClient(ClientPrx c, java.util.Map<String, String> context)
    {
        _iceI_addClientAsync(c, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> addClientAsync(ClientPrx c)
    {
        return _iceI_addClientAsync(c, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> addClientAsync(ClientPrx c, java.util.Map<String, String> context)
    {
        return _iceI_addClientAsync(c, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_addClientAsync(ClientPrx iceP_c, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default void calculatePi()
    {
        calculatePi(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void calculatePi(java.util.Map<String, String> context)
    {
        _iceI_calculatePiAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> calculatePiAsync()
    {
        return _iceI_calculatePiAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> calculatePiAsync(java.util.Map<String, String> context)
    {
        return _iceI_calculatePiAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_calculatePiAsync(java.util.Map<String, String> context, boolean sync)
    {
    ...
    default void requestPoints(int n)
    {
        requestPoints(n, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void requestPoints(int n, java.util.Map<String, String> context)
    {
        _iceI_requestPointsAsync(n, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> requestPointsAsync(int n)
    {
        return _iceI_requestPointsAsync(n, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> requestPointsAsync(int n, java.util.Map<String, String> context)
    {
        return _iceI_requestPointsAsync(n, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_requestPointsAsync(int iceP_n, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "requestPoints", null, sync, null);
        f.invoke(false, context, null, ostr -> {
