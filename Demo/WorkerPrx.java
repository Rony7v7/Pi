...
{
    default void throwPoints(int n)
    {
        throwPoints(n, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void throwPoints(int n, java.util.Map<String, String> context)
    {
        _iceI_throwPointsAsync(n, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> throwPointsAsync(int n)
    {
        return _iceI_throwPointsAsync(n, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> throwPointsAsync(int n, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_throwPointsAsync(int iceP_n, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "throwPoints", null, sync, null);
